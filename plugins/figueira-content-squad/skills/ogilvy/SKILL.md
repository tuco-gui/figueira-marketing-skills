...
Skill especializada em redigir posts para LinkedIn seguindo prompts-mestre modulares. Entrega o post final pronto para aprovação — sem preâmbulo, sem meta-comentário, sem "aqui está".
