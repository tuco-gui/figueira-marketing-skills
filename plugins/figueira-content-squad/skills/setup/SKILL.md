...
> **Regra crítica:** a skill gera arquivos seguindo a **estrutura literal** dos templates em `contrato_projeto_cliente/`. Mesmas seções, mesmos campos, mesma ordem. O conteúdo é destilado dos seus inputs.
