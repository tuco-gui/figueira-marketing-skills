...
A lightweight, destination-aware prompt compiler for coding, text, design, image and video workflows.
...
- **modality** — text, coding, design, image, video or mixed;
...
This makes combinations such as **Higgsfield + Seedance** or **Adobe Firefly + an external model** possible without pretending the hosting surface and the generation model are the same thing.
...
- Claude Design uses a design-artifact brief rather than an image-generator prompt.
...
Image/video surfaces and models:
...
I need an interactive prototype for...
```
